...
export function BuilderDialog({
  open, onOpenChange, editingId, name, onNameChange,
  desc, onDescChange, category, onCategoryChange,
  trigger, onTriggerChange, steps, onStepsChange,
  selectedStepId, onSelectStep, onSave,
}: BuilderDialogProps) {
