...
export default function LicensesPage() {
	...
	const getApiStatusParam = useCallback(
		(filter: StatusFilter): string | undefined => {
					...
					{!selectMode ? (
						<>
							{canManage && (
								...
								>
									<CheckSquare className="size-3.5 me-1.5" />
									{tb("selectMode")}
								</Button>
							)}
							<Button
			...
			<div className="flex flex-col sm:flex-row gap-3">
				<div className="relative flex-1 max-w-sm">
					...
					<Input
						...
						className="ps-9 border-slate-200 dark:border-slate-700"
					/>
				</div>
			...
			<AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
				<AlertDialogContent>
					...
					<AlertDialogFooter>
						...
						>
							{bulkDeleting && <Loader2 className="size-4 animate-spin me-2" />}
							{tc("delete")}
						</AlertDialogAction>
					</AlertDialogFooter>
				</AlertDialogContent>
