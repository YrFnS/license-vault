	...
	return (
		<div className="min-h-screen flex flex-col bg-white dark:bg-slate-950">
			...
			<main className="flex-1">
							...
							<div className="lg:col-span-2 flex flex-col gap-4">
								...
								<div className="rounded-lg border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 p-5">
									...
									<p className="text-xs text-slate-500 mt-1">
										California Plumbing License, Texas HV, Nevada General
									</p>
								</div>
					...
					<div className="mx-auto max-w-6xl px-4 md:px-6 py-16 md:py-24">
						...
						<div className="grid grid-cols-1 md:grid-cols-4 gap-4">
							...
							{[
								...
								>
									<div
										className={`size-9 rounded-lg ${color} flex items-center justify-center mb-3`}
									>
				...
				<section
					id="how-it-works"
					className="border-b border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/30"
				>
					<div className="mx-auto max-w-6xl px-4 md:px-6 py-16 md:py-24">
						<div className="max-w-2xl mb-12">
							<p className="text-xs font-medium uppercase tracking-wider text-emerald-600 mb-2">
							...
							{[
								...
								<div key={titleKey} className="flex gap-4">
									<div className="shrink-0">
										<div
											className={`size-10 rounded-lg ${color} flex items-center justify-center`}
										>
									...
									<div>
										...
										<p className="mt-1 text-sm text-slate-500 leading-relaxed">
											{t(`howItWorks.${titleKey}.description`)}
										</p>
									</div>
								</div>
							))}
					...
					<div className="mx-auto max-w-6xl px-4 md:px-6 py-16 md:py-24">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl">
							...
							<div className="rounded-lg border border-slate-200 dark:border-slate-800 p-6">
								...
								<Button
									variant="outline"
									className="w-full mt-6 border-slate-300 dark:border-slate-700"
									asChild
								>
