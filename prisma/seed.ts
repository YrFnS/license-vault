...
async function main() {
	...
	const complianceCategories = [
		{
			...
			description: "Active, expired, or expiring contractor licenses",
		},
		{
			key: "insurance",
			name: "Insurance Compliance",
			description: "COIs, coverage limits, and endorsement requirements",
		},
		{
			key: "ce_credits",
			name: "Continuing Education",
			description: "CE hours required for license renewal",
		},
		{
			key: "entity",
			name: "Business Entity Standing",
			description: "LLC/corp state filing and annual report status",
		},
		{
			key: "bond",
			name: "Bond Compliance",
			description: "Surety bonds required for license qualification",
		},
		{
			key: "registration",
			name: "State Registration",
			description: "Out-of-state contractor registration requirements",
		},
	];
	...
	await prisma.checklistTemplate.upsert({
		...
		create: {
			...
			description:
				"Standard checklist for contractor license renewal applications",
			...
			items: JSON.stringify([
				{
					id: "1",
					label: "Verify current license status with state board",
					required: true,
				},
				{ id: "2", label: "Complete CE hour requirements", required: true },
				{
					id: "3",
					label: "Obtain current COI from insurance provider",
					required: true,
				},
				{ id: "4", label: "Pay state renewal fee", required: true },
				{
					id: "5",
					label: "Submit renewal application before deadline",
					required: true,
				},
				{
					id: "6",
					label: "Update business entity annual report if needed",
					required: false,
				},
				{
					id: "7",
					label: "Verify bond status / obtain new bond if required",
					required: false,
				},
				{
					id: "8",
					label: "Update contact information with state board",
					required: false,
				},
			]),
		},
	...
	await prisma.checklistTemplate.upsert({
		...
		create: {
			...
			description:
				"Initial setup checklist for new License Vault organizations",
			category: "general",
			isDefault: true,
			isActive: true,
			orgId: "system",
			items: JSON.stringify([
				{
					id: "1",
					label: "Add primary organization details and trade type",
					required: true,
				},
				{ id: "2", label: "Invite team members", required: false },
				{
					id: "3",
					label: "Add all active contractor licenses",
					required: true,
				},
				{
					id: "4",
					label: "Upload current insurance certificates",
					required: true,
				},
				{
					id: "5",
					label: "Add qualifiers and link to licenses",
					required: true,
				},
				{ id: "6", label: "Configure alert preferences", required: false },
				{
					id: "7",
					label: "Set up subcontractor portal access",
					required: false,
				},
				{
					id: "8",
					label: "Add active projects and required licenses",
					required: false,
				},
			]),
		},
